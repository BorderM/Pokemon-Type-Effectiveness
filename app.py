...
def get_profile_payload(raw_name):
    ...
    profile_details, profile_cache_meta = get_local_profile_details(key, species)
    abilities = profile_details.get('abilities', []) if isinstance(profile_details, dict) else []
    moves_by_generation = profile_details.get('moves_by_generation', {}) if isinstance(profile_details, dict) else {}
    ...
    return {
        ...
        'data_sources': {
            'local_cache': True,
            'offline_profile_details': bool(profile_details),
